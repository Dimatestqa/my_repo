...
public class Valid_Appliance_New_Customer_Invalid_Student {
    ...
    public Valid_Appliance_New_Customer_Invalid_Student(final String BrowserType, final String DateOfBirth, final int Month_Duration, final String Name, final String Product) {
    ...
    public static Collection<Object[]> dataSets() {
        return asList(new Object[][]{
            {"Chrome", "12/25/2000", 10, "John Smith", "Hair dryer"}
        });
    }
